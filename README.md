...
VCP 支持静态、服务器、同步、异步、注入式、混合式六大类型插件：
...
- **相同方式共享 (SA)**：如果您再混合、转换或者基于本作品
我看到您遇到了一些插件执行错误。让我继续完成 README.md 的剩余部分：
...
- **核心开发团队**：7 个 AI Agent 在人类引导下协同完成了主要代码编写
