...
本轮未执行 `git fetch`，只基于当前本地 remote-tracking refs 做只读复核。

| 引用 | HEAD | 是否为 `main` 祖先 | `main...ref` left/right |
| --- | --- | --- | --- |
| `prod/stable` | `a1870b3` | 是 | `159 / 0` |
| `origin/prod/stable` | `a1870b3` | 是 | `159 / 0` |
| `upstream/main` | `8b8a71d` | 是 | `261 / 0` |
| `origin/main` | `ee2d324` | 否 | `398 / 18` |
