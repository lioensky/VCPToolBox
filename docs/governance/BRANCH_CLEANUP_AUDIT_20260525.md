...
- 当前 left/right：`main...prod/stable = 166 / 0`，`main...origin/prod/stable = 166 / 0`，`main...upstream/main = 268 / 0`，`main...origin/main = 405 / 18`。
...
- Package D 已部分执行；Package E 已有 preflight 候选清单与保护检查口径，但仍未执行。
