...
**推奨バックエンド**：SSE ストリーミング出力とフォーマット標準化に対応した公式または集約 API。例えば [NewAPI](https://github.com/QuantumNous/new-api) や [OpenRouter](https://openrouter.ai/)、[OrcaRouter](https://www.orcarouter.ai) などです。繰り返しますが、**リバースプロキシ API や中継 API は使用しないでください**。
