...
function createSerumBottleSecretlessBody(overrides = {}) {
    const body = {
        pipeline_id: 'secretless-serum-live-probe-attempt-013',
        task_id: 'AUTH-SECRETLESS-SERUM-LIVE-PROBE-20260603-013',
        ...
        plan: {
            steps: [{
                ...
                output_directory_ref: 'runs/real_generation/runtime_to_review_v1_guarded_live_probe_serum_bottle_secretless_attempt_013/'
            }]
        },
        ...overrides
    };
...
test('aiImageAgents serum-bottle secretless helper authorizes internally before stubbed execution', async () => {
    ...
    await withRouteModule({
        ...
        assert.equal(authorizerCalls[0].activationPackageId, 'AUTH-SECRETLESS-SERUM-LIVE-PROBE-20260603-013');
        ...
        assert.deepEqual(calls[0].options.executionContext, {
            requestSource: 'ai-image-pipeline',
            operatorId: 'vcptoolbox-internal-serum',
            taskId: 'AUTH-SECRETLESS-SERUM-LIVE-PROBE-20260603-013',
            invocationId: 'secretless-serum-live-probe-attempt-013',
